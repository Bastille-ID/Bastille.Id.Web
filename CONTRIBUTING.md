...
For this Project, we use [GitHub Issues](https://github.com/Bastille-ID/Bastille.Id.Web/issues) to track all tasks related to this project.
...
Once you get the project built, see if you can fix some [issues](https://github.com/Bastille-ID/Bastille.Id.Web/issues).
...
```
$ git clone https://github.com/YOUR-USERNAME/Bastille.Id.Web
```
...
1. Find the [New Pull Request](https://github.com/Bastille-ID/Bastille.Id.Web/compare/) button
